...
Wire_USCI<0, UCB0CTL0, UCB0CTL1, UCB0BR0, UCB0BR1, UCB0STAT, UCB0I2COA, UCB0I2CSA, UCB0TXBUF, UCB0RXBUF, UCB0I2CIE, UCB0STAT, IE2, IFG2, P1SEL, P1SEL2, PORT_SELECTION_0_AND_1, BIT6|BIT7, 16, 16> Wire;
...
int main()
{
	...
	while(1) {
		...
		if (Wire.endTransmission()) {
			Serial.println("Sent 14 bytes to 0x28 at address 0x26");
			Wire.beginTransmission(0x28);
			Wire.write(0x00); Wire.write(0x26);  // Re-set the RF430CL330H chip's pointer
			Wire.endTransmission();
		} else {
			Serial.println("Error sending I2C data");
		}
		delay(250);
		...
		if (i) {
			...
			Serial.println("Error reading from I2C 0x28");
		}
